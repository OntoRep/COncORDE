...
Instructions on how to use this ontology together with  [EDXL vocabulary](https://www.w3.org/TR/owl-time/) are provided in the wiki pages of this repository. Basic tutorial can be found from: https://github.com/OntoRep/COncORDE/wiki/Creating-an-incident-description.
